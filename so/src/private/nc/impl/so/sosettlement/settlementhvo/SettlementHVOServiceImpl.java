            ...
            for (AggSettlementHVO vo : vos) {
                ...
                if (transtype != null && "KHJS-Cxx-02".equals(transtype)) {
                    ...
                    if (count_saleinvoice != 0) {
                        ExceptionUtils.wrappBusinessException("该单据已经生成销售发票,不能取消审批");
                    ...
                    String cordercustid = vo.getChildrenVO()[0].getAttributeValue("cordercustid").toString();//客户
                    //查询该客户本月有没有生成过汇总单
                    ...
                    if (count_in != 0) {
                        ExceptionUtils.wrappBusinessException("该客户本月已经生成过汇总单，不能取消审批!");
                    }
                }
            }
        }
