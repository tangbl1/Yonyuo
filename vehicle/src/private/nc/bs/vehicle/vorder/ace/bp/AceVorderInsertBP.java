...
public class AceVorderInsertBP {
	...
	public AggVorderHVO[] insert(AggVorderHVO[] bills) {

		InsertBPTemplate<AggVorderHVO> bp = new InsertBPTemplate<AggVorderHVO>(
				VorderPluginPoint.INSERT);
	...
	private void addBeforeRule(AroundProcesser<AggVorderHVO> processer) {
		...
		((nc.bs.pubapp.pub.rule.CreateBillCodeRule) rule).setCbilltype("VORD");
