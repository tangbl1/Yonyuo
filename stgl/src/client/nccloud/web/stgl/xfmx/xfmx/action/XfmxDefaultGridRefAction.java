 ...
 * 
 */
public class XfmxDefaultGridRefAction extends DefaultGridRefAction {
	
	public XfmxDefaultGridRefAction() {
		super();
	...
	public RefMeta getRefMeta(RefQueryInfo refQueryInfo) {
		...
		refMeta.setPkField("pk_xfmx");
		refMeta.setTableName("comsumelog");
